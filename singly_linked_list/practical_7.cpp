...

{
...

          {
           ...
           cin>>enode->ssn>>enode->name>>enode->dept>>enode->designation>>enode->sal>>enode->phone;
...

{
        ...
        cout<<"\nENode:"<<nodeno<<"||SN:"<<cur->ssn<<"||Name:"<<cur->name<<"||Department:"<<cur->dept<<"||Designation:"<<cur->designation<<"||Salary:"<<cur->sal<<"||Phone no:"<< cur->phone;
